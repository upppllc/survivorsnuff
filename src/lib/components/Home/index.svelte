...
<style>
  ...
  .season-panel { position: relative; isolation: isolate; overflow: hidden; width: 88%; justify-self: center; padding: 2.8rem; border: 1px solid var(--snuff-border); border-radius: 1.6rem; background: var(--snuff-surface); transform: rotate(2deg); }
  ...
  .season-panel-number { color: var(--snuff-text); font-size: clamp(11.44rem, 15.84vw, 18.48rem); font-weight: 780; line-height: .9; letter-spacing: -.09em; text-align: center; padding: 2.8rem 1.4rem 0 0; }
  ...
  @media (max-width: 600px) {
    ...
    .season-panel { transform: none; padding: 2.1rem; }
    .season-panel-number { font-size: 10.56rem; padding-top: 2.1rem; }
