...
export function create_home_manager(config) {
  ...
  return {
    ...
    page_description: `Meet all ${castaway_count} Survivor ${season.season_number} castaways. Get names, photos, ages, hometowns and jobs, then save a grid or detailed cast sheet for premiere night.`,
